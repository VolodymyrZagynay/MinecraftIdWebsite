const objects = [
    ...
    { id: 16, name: "Coal Ore", description: "You know what they say! No power without the fire!", type: "block", img: "../Images/Blocks/Coal_Ore.png" },
    ...
    { id: 21, name: "Lapis Lazuli Ore", description: "Lapis.", type: "block", img: "../Images/Blocks/Lapis_Lazuli_Ore.png" },
    ...
    { id: 26, name: "Bed", description: "Let's just say, a good sleep, will make your day.", type: "block", img: "../Images/Blocks/Red_Bed.png" },
    ...
    { id: 30, name: "CobWeb", description: "Look's like you're not alone!", type: "block", img: "../Images/Blocks/CobWeb.png" },
    { id: 31.0, name: "Dead Bush", description: "I actually don't know the difference with 'Dead Shrub' lol", type: "block", img: "../Images/Blocks/Dead_Bush.png" },
    { id: 31.1, name: "Grass", description: "At least in THIS game, your PC can show the grass in the terrain lol", type: "block", img: "../Images/Blocks/Grass.png" },
    { id: 31.2, name: "Fern", description: "I can feel how you smoked that weed", type: "block", img: "../Images/Blocks/Fern.png" },
    { id: 32, name: "Dead_Shrub", description: "I actually don't know the difference with 'Dead Bush' lol", type: "block", img: "../Images/Blocks/Dead_Shrub.png" },
    { id: 33, name: "Piston", description: "Pes Piston!", type: "block", img: "../Images/Blocks/Piston.png" },
    { id: 34, name: "Piston Head", description: "For some reason :/", type: "block", img: "../Images/Blocks/Piston_Head.png" },
    ...
    { id: 36, name: "Piston Push", description: "When 'Piston' is pushing smt, that object is creating. And it haven't (as I understood) any texture. Also it was renamed in latest ver the id", type: "block", img: "../Images/Blocks/Porrige.png" },
